...
//Guesses as to what's what
// First byte:
//   Bit 4: doubler
//   Bits 3-0: Carrier = 499.2*X
const uint8 pll2_config[NUM_CH][5] =
{
    { 0x07, 0x04, 0x00, 0x09, 0x1E},//{ 0x0A, 0x14, 0x40, 0x08, 0x76},// //3.5Ghz
                                    //                                  
    { 0x08, 0x05, 0x40, 0x08, 0x26},//{ 0x0B, 0x1A, 0xE0, 0x06, 0x8E},// //4Ghz
                                    //                                  
    { 0x09, 0x10, 0x40, 0x08, 0x5E},//{ 0x1C, 0x05, 0x40, 0x08, 0xA6},// //4.5Ghz
